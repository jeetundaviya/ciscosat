...
class UserUpdateWork extends StatefulWidget {
  @override
  _UserUpdateWorkState createState() => _UserUpdateWorkState();
}

String _dustbinno, _dustbinvalue;

class _UserUpdateWorkState extends State<UserUpdateWork> {
  @override
