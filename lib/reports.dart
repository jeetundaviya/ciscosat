            ...
            StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, remarks) {
                  ...
                  for (var user in remarks.data.documents) {
                    ...
                    Column fieldbutton1 = Column(children: <Widget>[
                      Container(
                        height: 40,
                        width: 300,
                        child: Padding(
                          padding: const EdgeInsets.fromLTRB(30, 5, 0, 0),
                          child: Text(TempField1 + '        :  ' + TempRemark1,
...
//
                    ...
                    Column fieldbutton2 = Column(children: <Widget>[
                      Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.fromLTRB(30, 5, 0, 0),
                          child: Text(TempField2 + '        :  ' + TempRemark2,
                            style: GoogleFonts.titilliumWeb(
                                color: Colors.white, fontSize: 20),),
                        ),
                        decoration: BoxDecoration(
...
//                                      topRight: const  Radius.circular(15.0)),
                    ...
                    Column fieldbutton3 = Column(children: <Widget>[
                      Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.fromLTRB(30, 5, 0, 0),
                          child: Text(TempField3 + '  :  ' + TempRemark3,
                            style: GoogleFonts.titilliumWeb(
                                color: Colors.white, fontSize: 20),),
                        ),
                        decoration: BoxDecoration(
